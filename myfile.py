...
if menu == "Área Deforestada por Categoría de ANP":
    ...
    st.write("Categorías detectadas:", filtered_data["CATEGORIA"].unique())
    ...
    if filtered_data.empty:
        ...
        st.write("Datos agrupados:", sum_area_deforestation)
        ...
        for categoria in categorias:
            ...
            if categoria_data.empty:
                ...
                fig.update_layout(xaxis_tickangle=-45)  # Rotar etiquetas largas
